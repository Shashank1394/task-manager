              ...
              <div className="time-project-bars">
                ...
                {projectSummaries.every(
                  ...
                  <p className="dash-empty">
                    No time estimates yet. Add estimates to your tasks to see
                    the breakdown.
                  </p>
                )}
              </div>
        ...
        <aside className="dash-aside">
          ...
          <div className="dash-card">
            ...
            <div className="status-donut-container">
              <svg viewBox="0 0 36 36" className="status-donut">
                {(() => {
                  if (totalTasks === 0)
                    return (
                      <circle
                  ...
                  const todoPct = (byStatus.TODO / totalTasks) * 100;
                  const ipPct = (byStatus.IN_PROGRESS / totalTasks) * 100;
                  const donePct = (byStatus.DONE / totalTasks) * 100;
                  return (
                    <>
                      <circle
                        cx="18"
                      ...
                      <circle
                        ...
                        stroke="#3b82f6"
                        strokeWidth="3"
                        strokeDasharray={`${ipPct} ${100 - ipPct}`}
                      ...
                      <circle
                        ...
                        strokeDashoffset={`${25 - todoPct - ipPct}`}
                      />
                    </>
                  );
                })()}
                <text x="18" y="18" className="donut-center-text">
                  {totalTasks}
                </text>
              </svg>
            </div>
            <div className="status-legend">
              <div className="status-legend-item">
                ...
                />
                <span className="status-legend-label">To Do</span>
                <span className="status-legend-count">{byStatus.TODO}</span>
              </div>
              <div className="status-legend-item">
                <span
                  className="status-legend-dot"
                ...
                />
                <span className="status-legend-label">In Progress</span>
              ...
              <div className="status-legend-item">
                ...
                />
                <span className="status-legend-label">Done</span>
                <span className="status-legend-count">{byStatus.DONE}</span>
              </div>
            </div>
          </div>
